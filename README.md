...
**al-folio** comes with stylish layouts for pages and article posts.

#### The iconic style of Distill

The theme allows you to create article posts in the [distill.pub](https://distill.pub/) style:

[![Distill Preview](readme_preview/distill.png)](https://alshedivat.github.io/al-folio/articles/2021/distill/)

For more details on how to create distill-styled posts using `<d-*>` tags, please refer to [the example](https://alshedivat.github.io/al-folio/articles/2021/distill/).
...
<p align="center">
<a href="https://alshedivat.github.io/al-folio/articles/2015/math/" target="_blank"><img src="readme_preview/math.png" width=400></a>
<a href="https://alshedivat.github.io/al-folio/articles/2015/code/" target="_blank"><img src="readme_preview/code.png" width=400></a>
</p>

#### Photos, Audio, Video and more

Photo formatting is made simple using [Bootstrap's grid system](https://getbootstrap.com/docs/4.4/layout/grid/). Easily create beautiful grids within your articles and project pages, also with support for [video](https://alshedivat.github.io/al-folio/articles/2023/videos/) and [audio](https://alshedivat.github.io/al-folio/articles/2023/audios/) embeds:
...
By default, there will be a related posts section on the bottom of article pages. These are generated by selecting the `max_related` most recent articles that share at least `min_common_tags` tags with the current article. If you do not want to display related posts on a specific article, simply add `related_posts: false` to the front matter of the article. If you want to disable it for all articles, simply set `enabled` to false in the `related_blog_posts` section in [\_config.yml](_config.yml).
