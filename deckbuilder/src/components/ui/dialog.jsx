...
const DialogTitle = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return <DialogPrimitive.Title ref={ref} className={cn("text-lg font-semibold leading-none tracking-tight", className)} {...restProps} />;
});
DialogTitle.displayName = DialogPrimitive.Title.displayName;

const DialogDescription = React.forwardRef((props, ref) => {
  const { className, ...restProps } = props;
  return <DialogPrimitive.Description ref={ref} className={cn("text-sm text-muted-foreground", className)} {...restProps} />;
});
