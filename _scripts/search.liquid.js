...
ninja.data = [
  ...
  {%- for p in sorted_pages -%}
    {%- if p.nav and p.autogen == null and p.permalink != '/events/' and p.permalink != '/food/' and p.permalink != '/books/' -%}
      {%- if p.dropdown -%}
        {%- for child in p.children -%}
          {%- unless child.title == 'divider' -%}
            {
              {%- assign title = child.title | escape | strip -%}
              {%- if child.permalink contains "/articles/" -%}{%- assign url = "/articles/" -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/articles/" -%}{%- assign url = "/articles/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
  ...
  {%- for collection in site.collections -%}
    {%- if collection.label != 'posts' and collection.label != 'events' and collection.label != 'food' and collection.label != 'books' -%}
