...
categories: Cube food
thumbnail: assets/img/soup-on-sarpadia/2.png
toc:
  sidebar: left
images:
  photoswipe: true
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/1.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
This event was simple:
3 round “Sarpadia Remastered” Cube Draft, modern rules with mana burn.
Entry: a homemade dish, prizes were donated, and one player would walk away as the Soup-reme ruler of Sarpadia!
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/2.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/3.png" class="img-fluid rounded z-depth-1" zoomable=true %}

Brad Wayne, Mitty Harmon, Paul Blakely, Mike Klements, Taylor Kane, Christopher Benson, Halle McLaughlin + Kevin Kelsey.

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/5.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/6.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/7.png" class="img-fluid rounded z-depth-1" zoomable=true %}

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/8.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/9.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>

## Taylor’s B/W “Kindred Removal”

{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/10.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/11.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/12.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/13.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/14.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/15.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/soup-on-sarpadia/16.png" class="img-fluid rounded z-depth-1" zoomable=true %}

Thanks all for another fantastic mini-event, and for those that read this far, for indulging!
Hopefully see you in Sarpadia (or otherwise) soon!
